...
public class JSGraphQLEndpointQuotedStringImpl extends JSGraphQLEndpointPsiElement implements JSGraphQLEndpointQuotedString {

  public JSGraphQLEndpointQuotedStringImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public JSGraphQLEndpointString getString() {
    return findChildByClass(JSGraphQLEndpointString.class);
  }
