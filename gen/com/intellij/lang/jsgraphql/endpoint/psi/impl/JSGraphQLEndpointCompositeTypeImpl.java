...
public class JSGraphQLEndpointCompositeTypeImpl extends JSGraphQLEndpointPsiElement implements JSGraphQLEndpointCompositeType {

  public JSGraphQLEndpointCompositeTypeImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public JSGraphQLEndpointListType getListType() {
    return findChildByClass(JSGraphQLEndpointListType.class);
  }
