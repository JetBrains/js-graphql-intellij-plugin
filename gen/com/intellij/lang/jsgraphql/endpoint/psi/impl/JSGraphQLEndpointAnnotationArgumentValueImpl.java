...
public class JSGraphQLEndpointAnnotationArgumentValueImpl extends JSGraphQLEndpointPsiElement implements JSGraphQLEndpointAnnotationArgumentValue {

  public JSGraphQLEndpointAnnotationArgumentValueImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JSGraphQLEndpointVisitor visitor) {
    visitor.visitAnnotationArgumentValue(this);
  }
  ...
  public JSGraphQLEndpointQuotedString getQuotedString() {
    return findChildByClass(JSGraphQLEndpointQuotedString.class);
  }
