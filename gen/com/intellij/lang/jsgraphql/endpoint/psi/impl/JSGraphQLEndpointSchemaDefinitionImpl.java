...
public class JSGraphQLEndpointSchemaDefinitionImpl extends JSGraphQLEndpointPsiElement implements JSGraphQLEndpointSchemaDefinition {

  public JSGraphQLEndpointSchemaDefinitionImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public JSGraphQLEndpointOperationTypeDefinitionSet getOperationTypeDefinitionSet() {
    return findChildByClass(JSGraphQLEndpointOperationTypeDefinitionSet.class);
  }
