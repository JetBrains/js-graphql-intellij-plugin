...
public class JSGraphQLInjectedLanguageBlockBuilder extends DefaultInjectedLanguageBlockBuilder {

    public JSGraphQLInjectedLanguageBlockBuilder(@NotNull CodeStyleSettings settings) {
        super(settings);
    }
